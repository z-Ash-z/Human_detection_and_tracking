Now that you have read Primer and learned how to write tests using Google Test, it\textquotesingle{}s time to learn some new tricks. This document will show you more assertions as well as how to construct complex failure messages, propagate fatal failures, reuse and speed up your test fixtures, and use various flags with your tests.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md825}{}\doxysection{More Assertions}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md825}
This section covers some less frequently used, but still significant, assertions.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md826}{}\doxysubsection{Explicit Success and Failure}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md826}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md827}{}\doxysubsection{Exception Assertions}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md827}
...
{\itshape Availability}\+: Linux, Windows, Mac; since version 1.\+1.\+0.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md828}{}\doxysubsection{Predicate Assertions for Better Error Messages}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md828}
...
Google Test gives you three different options to solve this problem\+:\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md829}{}\doxysubsubsection{Using an Existing Boolean Function}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md829}
...
{\itshape Availability}\+: Linux, Windows, Mac\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md830}{}\doxysubsubsection{Using a Function That Returns an Assertion\+Result}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md830}
...
{\itshape Availability}\+: Linux, Windows, Mac; since version 1.\+4.\+1.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md831}{}\doxysubsubsection{Using a Predicate-\/\+Formatter}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md831}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md832}{}\doxysubsection{Floating-\/\+Point Comparison}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md832}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md834}{}\doxysubsubsection{Floating-\/\+Point Predicate-\/\+Format Functions}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md834}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md835}{}\doxysubsection{Windows H\+R\+E\+S\+U\+L\+T assertions}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md835}
...
{\itshape Availability}\+: Windows.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md836}{}\doxysubsection{Type Assertions}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md836}
...
{\itshape Availability\+:} Linux, Windows, Mac; since version 1.\+3.\+0.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md837}{}\doxysubsection{Assertion Placement}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md837}
...
If you want to test {\ttfamily E\+X\+P\+E\+C\+T\+\_\+$\ast$()/\+A\+S\+S\+E\+R\+T\+\_\+$\ast$()} failures in your test code, see \href{\#catching-failures}{\texttt{ Catching Failures}}.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md839}{}\doxysubsection{How to Write a Death Test}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md839}
...
{\itshape Availability\+:} Linux, Windows (requires M\+S\+VC 8.\+0 or above), Cygwin, and Mac (the latter three are supported since v1.\+3.\+0). {\ttfamily (A\+S\+S\+E\+R\+T$\vert$\+E\+X\+P\+E\+CT)\+\_\+\+D\+E\+A\+T\+H\+\_\+\+I\+F\+\_\+\+S\+U\+P\+P\+O\+R\+T\+ED} are new in v1.\+4.\+0.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md840}{}\doxysubsection{Regular Expression Syntax}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md840}
...
If the death test statement runs to completion without dying, the child process will nonetheless terminate, and the assertion fails.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md842}{}\doxysubsection{Death Tests And Threads}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md842}
...
It\textquotesingle{}s perfectly fine to create threads inside a death test statement; they are executed in a separate process and cannot affect the parent.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md843}{}\doxysubsection{Death Test Styles}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md843}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md844}{}\doxysubsection{Caveats}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md844}
...
Despite the improved thread safety afforded by the \char`\"{}threadsafe\char`\"{} style of death test, thread problems such as deadlock are still possible in the presence of handlers registered with {\ttfamily pthread\+\_\+atfork(3)}.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md845}{}\doxysection{Using Assertions in Sub-\/routines}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md845}
\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md846}{}\doxysubsection{Adding Traces to Assertions}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md846}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md847}{}\doxysubsection{Propagating Fatal Failures}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md847}
...
{\itshape Availability\+:} Linux, Windows, Mac. Assertions from multiple threads are currently not supported.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md849}{}\doxysubsubsection{Checking for Failures in the Current Test}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md849}
...
{\itshape Availability\+:} Linux, Windows, Mac. {\ttfamily Has\+Nonfatal\+Failure()} and {\ttfamily Has\+Failure()} are available since version 1.\+4.\+0.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md850}{}\doxysection{Logging Additional Information}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md850}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md851}{}\doxysection{Sharing Resources Between Tests in the Same Test Case}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md851}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md852}{}\doxysection{Global Set-\/\+Up and Tear-\/\+Down}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md852}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md853}{}\doxysection{Value Parameterized Tests}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md853}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md854}{}\doxysubsection{How to Write Value-\/\+Parameterized Tests}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md854}
To write value-\/parameterized tests, first you should define a fixture class. It must be derived from {\ttfamily \+::testing\+::\+Test\+With\+Param$<$T$>$}, where {\ttfamily T} is the type of your parameter values. {\ttfamily Test\+With\+Param$<$T$>$} is itself derived from {\ttfamily \mbox{\hyperlink{classtesting_1_1Test}{testing\+::\+Test}}}. {\ttfamily T} can be any copyable type. If it\textquotesingle{}s a raw pointer, you are responsible for managing the lifespan of the pointed values.
...
{\itshape Availability}\+: Linux, Windows (requires M\+S\+VC 8.\+0 or above), Mac; since version 1.\+2.\+0.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md855}{}\doxysubsection{Creating Value-\/\+Parameterized Abstract Tests}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md855}
...
Once they are defined, you can instantiate them by including {\ttfamily foo\+\_\+param\+\_\+test.\+h}, invoking {\ttfamily I\+N\+S\+T\+A\+N\+T\+I\+A\+T\+E\+\_\+\+T\+E\+S\+T\+\_\+\+C\+A\+S\+E\+\_\+\+P()}, and linking with {\ttfamily foo\+\_\+param\+\_\+test.\+cc}. You can instantiate the same abstract test case multiple times, possibly in different source files.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md856}{}\doxysection{Typed Tests}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md856}
...
{\itshape Availability\+:} Linux, Windows (requires M\+S\+VC 8.\+0 or above), Mac; since version 1.\+1.\+0.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md857}{}\doxysection{Type-\/\+Parameterized Tests}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md857}
...
{\itshape Availability\+:} Linux, Windows (requires M\+S\+VC 8.\+0 or above), Mac; since version 1.\+1.\+0.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md858}{}\doxysection{Testing Private Code}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md858}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md859}{}\doxysubsection{Static Functions}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md859}
...
However, a better approach is to move the private code into the {\ttfamily foo\+::internal} namespace, where {\ttfamily foo} is the namespace your project normally uses, and put the private declarations in a {\ttfamily $\ast$-\/internal.h} file. Your production {\ttfamily .cc} files and your tests are allowed to include this internal header, but your clients are not. This way, you can fully test your internal implementation without leaking it to your clients.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md860}{}\doxysubsection{Private Class Members}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md860}
...
\DoxyCodeLine{\}  // namespace my\_namespace}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md861}{}\doxysection{Catching Failures}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md861}
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md862}{}\doxysection{Getting the Current Test\textquotesingle{}s Name}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md862}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md863}{}\doxysection{Extending Google Test by Handling Test Events}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md863}
...
{\itshape Availability\+:} Linux, Windows, Mac; since v1.\+4.\+0.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md864}{}\doxysubsection{Defining Event Listeners}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md864}
...
\DoxyCodeLine{\};}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md865}{}\doxysubsection{Using Event Listeners}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md865}
...
You may append more than one listener to the list. When an {\ttfamily On$\ast$\+Start()} or {\ttfamily On\+Test\+Part\+Result()} event is fired, the listeners will receive it in the order they appear in the list (since new listeners are added to the end of the list, the default text printer and the default X\+ML generator will receive the event first). An {\ttfamily On$\ast$\+End()} event will be received by the listeners in the {\itshape reverse} order. This allows output by listeners added later to be framed by output from listeners added earlier.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md866}{}\doxysubsection{Generating Failures in Listeners}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md866}
...
We have a sample of failure-\/raising listener \href{../samples/sample10_unittest.cc}{\texttt{ here}}.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md867}{}\doxysection{Running Test Programs\+: Advanced Options}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md867}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md868}{}\doxysubsection{Selecting Tests}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md868}
This section shows various options for choosing which tests to run.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md869}{}\doxysubsubsection{Listing Test Names}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md869}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md870}{}\doxysubsubsection{Running a Subset of the Tests}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md870}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md871}{}\doxysubsubsection{Temporarily Disabling Tests}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md871}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md872}{}\doxysubsubsection{Temporarily Enabling Disabled Tests}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md872}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md873}{}\doxysubsection{Repeating the Tests}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md873}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md874}{}\doxysubsection{Shuffling the Tests}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md874}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md875}{}\doxysubsection{Controlling Test Output}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md875}
{\itshape  This section teaches how to tweak the way test results are reported.}

{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md876}{}\doxysubsubsection{Colored Terminal Output}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md876}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md877}{}\doxysubsubsection{Suppressing the Elapsed Time}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md877}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md878}{}\doxysubsubsection{Generating an X\+M\+L Report}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md878}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md879}{}\doxysubsection{Controlling How Failures Are Reported}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md879}
{\itshape  }\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md880}{}\doxysubsubsection{Turning Assertion Failures into Break-\/\+Points}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md880}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md881}{}\doxysubsubsection{Suppressing Pop-\/ups Caused by Exceptions}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md881}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md882}{}\doxysubsubsection{Letting Another Testing Framework Drive}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md882}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md883}{}\doxysubsection{Distributing Test Functions to Multiple Machines}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md883}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md884}{}\doxysection{Fusing Google Test Source Files}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md884}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md885}{}\doxysection{Where to Go from Here}\label{md_vendor_googletest_googletest_docs_V1_5_AdvancedGuide_autotoc_md885}
