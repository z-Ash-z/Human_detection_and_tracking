This page discusses the design of new Google \mbox{\hyperlink{classMock}{Mock}} features.\hypertarget{md_vendor_googletest_googlemock_docs_DesignDoc_autotoc_md135}{}\doxysection{Macros for Defining Actions}\label{md_vendor_googletest_googlemock_docs_DesignDoc_autotoc_md135}
\hypertarget{md_vendor_googletest_googlemock_docs_DesignDoc_autotoc_md136}{}\doxysubsection{Problem}\label{md_vendor_googletest_googlemock_docs_DesignDoc_autotoc_md136}
...
Our goal is to allow defining custom actions with the least amount of boiler-\/plate C++ requires.\hypertarget{md_vendor_googletest_googlemock_docs_DesignDoc_autotoc_md137}{}\doxysubsection{Solution}\label{md_vendor_googletest_googlemock_docs_DesignDoc_autotoc_md137}
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_DesignDoc_autotoc_md138}{}\doxysubsection{Parameterized actions}\label{md_vendor_googletest_googlemock_docs_DesignDoc_autotoc_md138}
...
You can view {\ttfamily A\+C\+T\+I\+ON} as a degenerated parameterized action where the number of parameters is 0.\hypertarget{md_vendor_googletest_googlemock_docs_DesignDoc_autotoc_md139}{}\doxysubsection{Advanced Usages}\label{md_vendor_googletest_googlemock_docs_DesignDoc_autotoc_md139}
\hypertarget{md_vendor_googletest_googlemock_docs_DesignDoc_autotoc_md140}{}\doxysubsubsection{Overloading Actions}\label{md_vendor_googletest_googlemock_docs_DesignDoc_autotoc_md140}
You can easily define actions overloaded on the number of parameters\+: 
\begin{DoxyCode}{0}
\DoxyCodeLine{ACTION\_P(Plus, a) \{ ... \}}
\DoxyCodeLine{ACTION\_P2(Plus, a, b) \{ ... \}}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_DesignDoc_autotoc_md141}{}\doxysubsubsection{Restricting the Type of an Argument or Parameter}\label{md_vendor_googletest_googlemock_docs_DesignDoc_autotoc_md141}
...
where {\ttfamily Static\+Assert\+Type\+Eq} is a compile-\/time assertion we plan to add to Google Test (the name is chosen to match {\ttfamily static\+\_\+assert} in C++0x).\hypertarget{md_vendor_googletest_googlemock_docs_DesignDoc_autotoc_md142}{}\doxysubsubsection{Using the A\+C\+T\+I\+O\+N Object\textquotesingle{}s Type}\label{md_vendor_googletest_googlemock_docs_DesignDoc_autotoc_md142}
...
{\ttfamily A\+C\+T\+I\+O\+N$\ast$} avoid all these problems.\hypertarget{md_vendor_googletest_googlemock_docs_DesignDoc_autotoc_md145}{}\doxysubsection{Future Improvements}\label{md_vendor_googletest_googlemock_docs_DesignDoc_autotoc_md145}
...
C++0x will also support lambda expressions. When they become available, we may want to support using lambdas as actions.\hypertarget{md_vendor_googletest_googlemock_docs_DesignDoc_autotoc_md146}{}\doxysection{Macros for Defining Matchers}\label{md_vendor_googletest_googlemock_docs_DesignDoc_autotoc_md146}
