({\bfseries{Note\+:}} If you get compiler errors that you don\textquotesingle{}t understand, be sure to consult Google Mock Doctor.)\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_ForDummies_autotoc_md313}{}\doxysection{What Is Google C++ Mocking Framework?}\label{md_vendor_googletest_googlemock_docs_v1_5_ForDummies_autotoc_md313}
...
\end{DoxyEnumerate}\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_ForDummies_autotoc_md314}{}\doxysection{Why Google Mock?}\label{md_vendor_googletest_googlemock_docs_v1_5_ForDummies_autotoc_md314}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_ForDummies_autotoc_md315}{}\doxysection{Getting Started}\label{md_vendor_googletest_googlemock_docs_v1_5_ForDummies_autotoc_md315}
Using Google \mbox{\hyperlink{classMock}{Mock}} is easy! Inside your C++ source file, just {\ttfamily \#include} {\ttfamily $<$\mbox{\hyperlink{gtest_8h_source}{gtest/gtest.\+h}}$>$} and {\ttfamily $<$\mbox{\hyperlink{gmock_8h_source}{gmock/gmock.\+h}}$>$}, and you are ready to go.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_ForDummies_autotoc_md316}{}\doxysection{A Case for Mock Turtles}\label{md_vendor_googletest_googlemock_docs_v1_5_ForDummies_autotoc_md316}
...
{\bfseries{Important note\+:}} Google \mbox{\hyperlink{classMock}{Mock}} requires expectations to be set {\bfseries{before}} the mock functions are called, otherwise the behavior is {\bfseries{undefined}}. In particular, you mustn\textquotesingle{}t interleave {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()}s and calls to the mock functions.

This means {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()} should be read as expecting that a call will occur {\itshape in the future}, not that a call has occurred. Why does Google \mbox{\hyperlink{classMock}{Mock}} work like that? Well, specifying the expectation beforehand allows Google \mbox{\hyperlink{classMock}{Mock}} to report a violation as soon as it arises, when the context (stack trace, etc) is still available. This makes debugging much easier.

Admittedly, this test is contrived and doesn\textquotesingle{}t do much. You can easily achieve the same effect without using Google \mbox{\hyperlink{classMock}{Mock}}. However, as we shall reveal soon, Google \mbox{\hyperlink{classMock}{Mock}} allows you to do {\itshape much more} with the mocks.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_ForDummies_autotoc_md321}{}\doxysubsection{Using Google Mock with Any Testing Framework}\label{md_vendor_googletest_googlemock_docs_v1_5_ForDummies_autotoc_md321}
...
If this turns out to be too much work, we suggest that you stick with Google Test, which works with Google \mbox{\hyperlink{classMock}{Mock}} seamlessly (in fact, it is technically part of Google \mbox{\hyperlink{classMock}{Mock}}.). If there is a reason that you cannot use Google Test, please let us know.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_ForDummies_autotoc_md322}{}\doxysection{Setting Expectations}\label{md_vendor_googletest_googlemock_docs_v1_5_ForDummies_autotoc_md322}
The key to using a mock object successfully is to set the {\itshape right expectations} on it. If you set the expectations too strict, your test will fail as the result of unrelated changes. If you set them too loose, bugs can slip through. You want to do it just right such that your test can catch exactly the kind of bugs you intend it to catch. Google \mbox{\hyperlink{classMock}{Mock}} provides the necessary means for you to do it \char`\"{}just right.\char`\"{}\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_ForDummies_autotoc_md323}{}\doxysubsection{General Syntax}\label{md_vendor_googletest_googlemock_docs_v1_5_ForDummies_autotoc_md323}
In Google \mbox{\hyperlink{classMock}{Mock}} we use the {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()} macro to set an expectation on a mock method. The general syntax is\+:
...
This checks that the turtle will be told to go forward by at least 100 units.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_ForDummies_autotoc_md325}{}\doxysubsection{Cardinalities\+: How Many Times Will It Be Called?}\label{md_vendor_googletest_googlemock_docs_v1_5_ForDummies_autotoc_md325}
...
(What if you care about the relative order of some of the calls, but not all of them? Can you specify an arbitrary partial order? The answer is ... yes! If you are impatient, the details can be found in the Cook\+Book.)\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_ForDummies_autotoc_md329}{}\doxysubsection{All Expectations Are Sticky (\+Unless Said Otherwise)}\label{md_vendor_googletest_googlemock_docs_v1_5_ForDummies_autotoc_md329}
