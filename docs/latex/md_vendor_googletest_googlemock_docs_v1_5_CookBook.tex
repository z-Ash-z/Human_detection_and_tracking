...
{\bfseries{Note\+:}} Google \mbox{\hyperlink{classMock}{Mock}} lives in the {\ttfamily testing} name space. For readability, it is recommended to write {\ttfamily using \+::testing\+::\+Foo;} once in your file before using the name {\ttfamily Foo} defined by Google \mbox{\hyperlink{classMock}{Mock}}. We omit such {\ttfamily using} statements in this page for brevity, but you should do it in your own code.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md242}{}\doxysection{Creating Mock Classes}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md242}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md243}{}\doxysubsection{Mocking Private or Protected Methods}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md243}
...
\DoxyCodeLine{\};}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md244}{}\doxysubsection{Mocking Overloaded Methods}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md244}
...
\DoxyCodeLine{\};}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md245}{}\doxysubsection{Mocking Class Templates}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md245}
...
\DoxyCodeLine{\};}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md246}{}\doxysubsection{Mocking Nonvirtual Methods}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md246}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md247}{}\doxysubsection{Mocking Free Functions}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md247}
...
\item However, this may also mean there\textquotesingle{}s a bug in the test, so Google \mbox{\hyperlink{classMock}{Mock}} shouldn\textquotesingle{}t be silent either. If the user believes these calls are harmless, he can add an {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()} to suppress the warning.
\end{DoxyItemize}
...
By defining a new mock method with a trimmed argument list, we make the mock class much more user-\/friendly.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md250}{}\doxysubsection{Alternative to Mocking Concrete Classes}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md250}
...
You need to weigh the pros and cons carefully for your particular problem, but I\textquotesingle{}d like to assure you that the Java community has been practicing this for a long time and it\textquotesingle{}s a proven effective technique applicable in a wide variety of situations. \+:-\/)\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md251}{}\doxysubsection{Delegating Calls to a Fake}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md251}
...
Instead, you can define a {\ttfamily File\+Ops} interface and an {\ttfamily I\+O\+Ops} interface and split {\ttfamily System}\textquotesingle{}s functionalities into the two. Then you can mock {\ttfamily I\+O\+Ops} without mocking {\ttfamily File\+Ops}.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md252}{}\doxysubsection{Delegating Calls to a Real Object}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md252}
...
(Why don\textquotesingle{}t we just write {\ttfamily Invoke(\&foo, \&\+Foo\+::\+Concrete)}? If you do that, {\ttfamily Mock\+Foo\+::\+Concrete()} will be called (and cause an infinite recursion) since {\ttfamily Foo\+::\+Concrete()} is virtual. That\textquotesingle{}s just how C++ works.)\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md254}{}\doxysection{Using Matchers}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md254}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md255}{}\doxysubsection{Matching Argument Values Exactly}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md255}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md256}{}\doxysubsection{Using Simple Matchers}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md256}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md257}{}\doxysubsection{Combining Matchers}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md257}
...
\DoxyCodeLine{                          NULL));}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md258}{}\doxysubsection{Casting Matchers}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md258}
...
{\ttfamily Matcher\+Cast} essentially lets you bypass C++\textquotesingle{}s type system ({\ttfamily static\+\_\+cast} isn\textquotesingle{}t always safe as it could throw away information, for example), so be careful not to misuse/abuse it.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md259}{}\doxysubsection{Selecting Between Overloaded Functions}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md259}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md260}{}\doxysubsection{Performing Different Actions Based on the Arguments}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md260}
...
Now, if {\ttfamily foo.\+Do\+This()} is called with a value less than 5, `\textquotesingle{}a'{\ttfamily will be returned; otherwise}\textquotesingle{}b\textquotesingle{}\`{} will be returned.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md261}{}\doxysubsection{Matching Multiple Arguments as a Whole}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md261}
...
As a convenience and example, Google \mbox{\hyperlink{classMock}{Mock}} provides some matchers for 2-\/tuples, including the {\ttfamily Lt()} matcher above. See the Cheat\+Sheet for the complete list.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md262}{}\doxysubsection{Using Matchers as Predicates}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md262}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md263}{}\doxysubsection{Using Matchers in Google Test Assertions}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md263}
...
{\bfseries{Credit\+:}} The idea of {\ttfamily (A\+S\+S\+E\+R\+T$\vert$\+E\+X\+P\+E\+CT)\+\_\+\+T\+H\+AT} was stolen from the \href{http://code.google.com/p/hamcrest/}{\texttt{ Hamcrest}} project, which adds {\ttfamily assert\+That()} to J\+Unit.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md264}{}\doxysubsection{Using Predicates as Matchers}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md264}
...
Note that the predicate function / functor doesn\textquotesingle{}t have to return {\ttfamily bool}. It works as long as the return value can be used as the condition in statement {\ttfamily if (condition) ...}.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md265}{}\doxysubsection{Matching Arguments that Are Not Copyable}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md265}
When you do an {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L(mock\+\_\+obj, Foo(bar))}, Google \mbox{\hyperlink{classMock}{Mock}} saves away a copy of {\ttfamily bar}. When {\ttfamily Foo()} is called later, Google \mbox{\hyperlink{classMock}{Mock}} compares the argument to {\ttfamily Foo()} with the saved copy of {\ttfamily bar}. This way, you don\textquotesingle{}t need to worry about {\ttfamily bar} being modified or destroyed after the {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()} is executed. The same is true when you use matchers like {\ttfamily Eq(bar)}, {\ttfamily Le(bar)}, and so on.

But what if {\ttfamily bar} cannot be copied (i.\+e. has no copy constructor)? You could define your own matcher function and use it with {\ttfamily Truly()}, as the previous couple of recipes have shown. Or, you may be able to get away from it if you can guarantee that {\ttfamily bar} won\textquotesingle{}t be changed after the {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()} is executed. Just tell Google \mbox{\hyperlink{classMock}{Mock}} that it should save a reference to {\ttfamily bar}, instead of a copy of it. Here\textquotesingle{}s how\+:
...
Remember\+: if you do this, don\textquotesingle{}t change {\ttfamily bar} after the {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()}, or the result is undefined.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md266}{}\doxysubsection{Validating a Member of an Object}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md266}
...
What if you want to validate more than one members at the same time? Remember that there is {\ttfamily All\+Of()}.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md267}{}\doxysubsection{Validating the Value Pointed to by a Pointer Argument}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md267}
...
What if you have a pointer to pointer? You guessed it -\/ you can use nested {\ttfamily Pointee()} to probe deeper inside the value. For example, {\ttfamily Pointee(Pointee(\+Lt(3)))} matches a pointer that points to a pointer that points to a number less than 3 (what a mouthful...).\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md268}{}\doxysubsection{Testing a Certain Property of an Object}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md268}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md269}{}\doxysubsection{Matching Containers}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md269}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md270}{}\doxysubsection{Sharing Matchers}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md270}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md271}{}\doxysection{Setting Expectations}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md271}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md272}{}\doxysubsection{Ignoring Uninteresting Calls}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md272}
If you are not interested in how a mock method is called, just don\textquotesingle{}t say anything about it. In this case, if the method is ever called, Google \mbox{\hyperlink{classMock}{Mock}} will perform its default action to allow the test program to continue. If you are not happy with the default action taken by Google \mbox{\hyperlink{classMock}{Mock}}, you can override it using {\ttfamily Default\+Value$<$T$>$\+::\+Set()} (described later in this document) or {\ttfamily O\+N\+\_\+\+C\+A\+L\+L()}.

Please note that once you expressed interest in a particular mock method (via {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()}), all invocations to it must match some expectation. If this function is called but the arguments don\textquotesingle{}t match any {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()} statement, it will be an error.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md273}{}\doxysubsection{Disallowing Unexpected Calls}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md273}
...
A call to {\ttfamily foo.\+Bar()} that doesn\textquotesingle{}t match any of the {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()} statements will be an error.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md274}{}\doxysubsection{Expecting Ordered Calls}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md274}
...
In this example, we expect a call to {\ttfamily foo.\+Do\+This(5)}, followed by two calls to {\ttfamily bar.\+Do\+That()} where the argument can be anything, which are in turn followed by a call to {\ttfamily foo.\+Do\+This(6)}. If a call occurred out-\/of-\/order, Google \mbox{\hyperlink{classMock}{Mock}} will report an error.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md275}{}\doxysubsection{Expecting Partially Ordered Calls}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md275}
...
Google \mbox{\hyperlink{classMock}{Mock}} allows you to impose an arbitrary D\+AG (directed acyclic graph) on the calls. One way to express the D\+AG is to use the After clause of {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+LL}.
...
This means that A must occur before B and C, and C must occur before D. There\textquotesingle{}s no restriction about the order other than these.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md276}{}\doxysubsection{Controlling When an Expectation Retires}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md276}
...
Here \#2 can be used only once, so if you have two warnings with the message {\ttfamily \char`\"{}\+File too large.\char`\"{}}, the first will match \#2 and the second will match \#1 -\/ there will be no error.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md277}{}\doxysection{Using Actions}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md277}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md278}{}\doxysubsection{Returning References from Mock Methods}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md278}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md279}{}\doxysubsection{Combining Actions}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md279}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md280}{}\doxysubsection{Mocking Side Effects}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md280}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md281}{}\doxysubsection{Changing a Mock Object\textquotesingle{}s Behavior Based on the State}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md281}
...
Here {\ttfamily my\+\_\+mock.\+Get\+Prev\+Value()} will always return the argument of the last {\ttfamily Update\+Value()} call.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md282}{}\doxysubsection{Setting the Default Value for a Return Type}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md282}
...
Please note that changing the default value for a type can make you tests hard to understand. We recommend you to use this feature judiciously. For example, you may want to make sure the {\ttfamily Set()} and {\ttfamily Clear()} calls are right next to the code that uses your mock.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md283}{}\doxysubsection{Setting the Default Actions for a Mock Method}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md283}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md286}{}\doxysubsection{Invoking an Argument of the Mock Function}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md286}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md287}{}\doxysubsection{Ignoring an Action\textquotesingle{}s Result}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md287}
...
Note that you {\bfseries{cannot}} use {\ttfamily Ignore\+Result()} on an action that already returns {\ttfamily void}. Doing so will lead to ugly compiler errors.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md288}{}\doxysubsection{Selecting an Action\textquotesingle{}s Arguments}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md288}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md289}{}\doxysubsection{Ignoring Arguments in Action Functions}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md289}
...
\DoxyCodeLine{      .WillOnce(Invoke(DistanceToOrigin));}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md290}{}\doxysubsection{Sharing Actions}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md290}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md291}{}\doxysection{Misc Recipes on Using Google Mock}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md291}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md292}{}\doxysubsection{Forcing a Verification}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md292}
...
{\bfseries{Tip\+:}} The {\ttfamily Mock\+::\+Verify\+And\+Clear\+Expectations()} function returns a {\ttfamily bool} to indicate whether the verification was successful ({\ttfamily true} for yes), so you can wrap that function call inside a {\ttfamily A\+S\+S\+E\+R\+T\+\_\+\+T\+R\+U\+E()} if there is no point going further when the verification has failed.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md293}{}\doxysubsection{Using Check Points}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md293}
...
And that\textquotesingle{}s that.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md295}{}\doxysubsection{Using Google Mock and Threads}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md295}
{\bfseries{I\+M\+P\+O\+R\+T\+A\+NT N\+O\+TE\+:}} What we describe in this recipe is {\bfseries{N\+OT}} true yet, as Google \mbox{\hyperlink{classMock}{Mock}} is not currently thread-\/safe. However, all we need to make it thread-\/safe is to implement some synchronization operations in {\ttfamily $<$\mbox{\hyperlink{gtest-port_8h_source}{gtest/internal/gtest-\/port.\+h}}$>$} -\/ and then the information below will become true.
...
Also, remember that {\ttfamily Default\+Value$<$T$>$} is a global resource that potentially affects {\itshape all} living mock objects in your program. Naturally, you won\textquotesingle{}t want to mess with it from multiple threads or when there still are mocks in action.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md296}{}\doxysubsection{Controlling How Much Information Google Mock Prints}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md296}
...
Now, judiciously use the right flag to enable Google \mbox{\hyperlink{classMock}{Mock}} serve you better!\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md297}{}\doxysubsection{Running Tests in Emacs}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md297}
...
Then you can type {\ttfamily M-\/m} to start a build, or {\ttfamily M-\/up}/{\ttfamily M-\/down} to move back and forth between errors.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md298}{}\doxysubsection{Fusing Google Mock Source Files}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md298}
...
The description string documents what the matcher does, and is used to generate the failure message when the match fails. Since a {\ttfamily M\+A\+T\+C\+H\+E\+R()} is usually defined in a header file shared by multiple C++ source files, we require the description to be a C-\/string {\itshape literal} to avoid possible side effects. It can be empty ({\ttfamily \char`\"{}\char`\"{}}), in which case Google \mbox{\hyperlink{classMock}{Mock}} will use the sequence of words in the matcher name as the description.
...
\end{DoxyEnumerate}\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md301}{}\doxysubsection{Writing New Parameterized Matchers Quickly}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md301}
...
While it\textquotesingle{}s tempting to always use the {\ttfamily M\+A\+T\+C\+H\+E\+R$\ast$} macros when defining a new matcher, you should also consider implementing {\ttfamily Matcher\+Interface} or using {\ttfamily Make\+Polymorphic\+Matcher()} instead (see the recipes that follow), especially if you need to use the matcher a lot. While these approaches require more work, they give you more control on the types of the value being matched and the matcher parameters, which in general leads to better compiler error messages that pay off in the long run. They also allow overloading matchers based on parameter types (as opposed to just based on the number of parameters).\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md302}{}\doxysubsection{Writing New Monomorphic Matchers}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md302}
A matcher of argument type {\ttfamily T} implements {\ttfamily \mbox{\hyperlink{classtesting_1_1MatcherInterface}{testing\+::\+Matcher\+Interface}}$<$T$>$} and does two things\+: it tests whether a value of type {\ttfamily T} matches the matcher, and can describe what kind of values it matches. The latter ability is used for generating readable error messages when expectations are violated.
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md303}{}\doxysubsection{Writing New Polymorphic Matchers}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md303}
...
Like in a monomorphic matcher, you may explain the match result by streaming additional information to the {\ttfamily listener} argument in {\ttfamily Match\+And\+Explain()}.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md304}{}\doxysubsection{Writing New Cardinalities}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md304}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md305}{}\doxysubsection{Writing New Actions Quickly}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md305}
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md306}{}\doxysubsection{Writing New Parameterized Actions Quickly}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md306}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md307}{}\doxysubsection{Restricting the Type of an Argument or Parameter in an A\+C\+T\+I\+ON}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md307}
...
where {\ttfamily Static\+Assert\+Type\+Eq} is a compile-\/time assertion in Google Test that verifies two types are the same.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md308}{}\doxysubsection{Writing New Action Templates Quickly}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md308}
...
Are we using a single-\/template-\/parameter action where {\ttfamily bool} refers to the type of {\ttfamily x}, or a two-\/template-\/parameter action where the compiler is asked to infer the type of {\ttfamily x}?\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md309}{}\doxysubsection{Using the A\+C\+T\+I\+O\+N Object\textquotesingle{}s Type}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md309}
...
Note that we have to pick different suffixes ({\ttfamily Action}, {\ttfamily ActionP}, {\ttfamily Action\+P2}, and etc) for actions with different numbers of value parameters, or the action definitions cannot be overloaded on the number of them.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md310}{}\doxysubsection{Writing New Monomorphic Actions}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md310}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md311}{}\doxysubsection{Writing New Polymorphic Actions}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md311}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md312}{}\doxysubsection{Teaching Google Mock How to Print Your Values}\label{md_vendor_googletest_googlemock_docs_v1_5_CookBook_autotoc_md312}
When an uninteresting or unexpected call occurs, Google \mbox{\hyperlink{classMock}{Mock}} prints the argument values to help you debug. The {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+T\+H\+AT} and {\ttfamily A\+S\+S\+E\+R\+T\+\_\+\+T\+H\+AT} assertions also print the value being validated when the test fails. Google \mbox{\hyperlink{classMock}{Mock}} does this using the user-\/extensible value printer defined in {\ttfamily $<$gmock/gmock-\/printers.\+h$>$}.
...
What if you have both {\ttfamily $<$$<$} and {\ttfamily Print\+To()}? In this case, the latter will override the former when Google \mbox{\hyperlink{classMock}{Mock}} is concerned. This allows you to customize how the value should appear in Google \mbox{\hyperlink{classMock}{Mock}}\textquotesingle{}s output without affecting code that relies on the behavior of its {\ttfamily $<$$<$} operator.

{\bfseries{Note\+:}} When printing a pointer of type {\ttfamily T$\ast$}, Google \mbox{\hyperlink{classMock}{Mock}} calls {\ttfamily Print\+To(\+T$\ast$, std\+::ostream$\ast$ os)} instead of {\ttfamily operator$<$$<$(std\+::ostream\&, T$\ast$)}. Therefore the only way to affect how a pointer is printed by Google \mbox{\hyperlink{classMock}{Mock}} is to define {\ttfamily Print\+To()} for it. Also note that {\ttfamily T$\ast$} and {\ttfamily const T$\ast$} are different types, so you may need to define {\ttfamily Print\+To()} for both.
