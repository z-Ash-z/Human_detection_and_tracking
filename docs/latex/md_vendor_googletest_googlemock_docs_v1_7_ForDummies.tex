...
\end{DoxyEnumerate}\hypertarget{md_vendor_googletest_googlemock_docs_v1_7_ForDummies_autotoc_md613}{}\doxysection{Why Google Mock?}\label{md_vendor_googletest_googlemock_docs_v1_7_ForDummies_autotoc_md613}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googlemock_docs_v1_7_ForDummies_autotoc_md614}{}\doxysection{Getting Started}\label{md_vendor_googletest_googlemock_docs_v1_7_ForDummies_autotoc_md614}
Using Google \mbox{\hyperlink{classMock}{Mock}} is easy! Inside your C++ source file, just {\ttfamily \#include} {\ttfamily \char`\"{}gtest/gtest.\+h\char`\"{}} and {\ttfamily \char`\"{}gmock/gmock.\+h\char`\"{}}, and you are ready to go.\hypertarget{md_vendor_googletest_googlemock_docs_v1_7_ForDummies_autotoc_md615}{}\doxysection{A Case for Mock Turtles}\label{md_vendor_googletest_googlemock_docs_v1_7_ForDummies_autotoc_md615}
...
Admittedly, this test is contrived and doesn\textquotesingle{}t do much. You can easily achieve the same effect without using Google \mbox{\hyperlink{classMock}{Mock}}. However, as we shall reveal soon, Google \mbox{\hyperlink{classMock}{Mock}} allows you to do {\itshape much more} with the mocks.\hypertarget{md_vendor_googletest_googlemock_docs_v1_7_ForDummies_autotoc_md620}{}\doxysubsection{Using Google Mock with Any Testing Framework}\label{md_vendor_googletest_googlemock_docs_v1_7_ForDummies_autotoc_md620}
...
If this turns out to be too much work, we suggest that you stick with Google Test, which works with Google \mbox{\hyperlink{classMock}{Mock}} seamlessly (in fact, it is technically part of Google \mbox{\hyperlink{classMock}{Mock}}.). If there is a reason that you cannot use Google Test, please let us know.\hypertarget{md_vendor_googletest_googlemock_docs_v1_7_ForDummies_autotoc_md621}{}\doxysection{Setting Expectations}\label{md_vendor_googletest_googlemock_docs_v1_7_ForDummies_autotoc_md621}
The key to using a mock object successfully is to set the {\itshape right expectations} on it. If you set the expectations too strict, your test will fail as the result of unrelated changes. If you set them too loose, bugs can slip through. You want to do it just right such that your test can catch exactly the kind of bugs you intend it to catch. Google \mbox{\hyperlink{classMock}{Mock}} provides the necessary means for you to do it \char`\"{}just right.\char`\"{}\hypertarget{md_vendor_googletest_googlemock_docs_v1_7_ForDummies_autotoc_md622}{}\doxysubsection{General Syntax}\label{md_vendor_googletest_googlemock_docs_v1_7_ForDummies_autotoc_md622}
...
This checks that the turtle will be told to go forward by at least 100 units.\hypertarget{md_vendor_googletest_googlemock_docs_v1_7_ForDummies_autotoc_md624}{}\doxysubsection{Cardinalities\+: How Many Times Will It Be Called?}\label{md_vendor_googletest_googlemock_docs_v1_7_ForDummies_autotoc_md624}
...
(What if you care about the relative order of some of the calls, but not all of them? Can you specify an arbitrary partial order? The answer is ... yes! If you are impatient, the details can be found in the Cook\+Book.)\hypertarget{md_vendor_googletest_googlemock_docs_v1_7_ForDummies_autotoc_md628}{}\doxysubsection{All Expectations Are Sticky (\+Unless Said Otherwise)}\label{md_vendor_googletest_googlemock_docs_v1_7_ForDummies_autotoc_md628}
